...
exports.PerformanceModule = PerformanceModule = __decorate([
    (0, common_1.Module)({
        imports: [files_module_1.FilesModule, prisma_module_1.PrismaModule, auth_module_1.AuthModule, notifications_module_1.NotificationsModule],
        controllers: [performance_controller_1.PerformanceController],
        providers: [performance_service_1.PerformanceService, efficiency_service_1.EfficiencyService],
        exports: [performance_service_1.PerformanceService, efficiency_service_1.EfficiencyService]
    })
], PerformanceModule);
